  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      Copyright &copy; <script>document.write(new Date().getFullYear())</script> <a href="https://yuhlez.com"><strong>Yuhlez Software House</strong> </a> All rights reserved.
    </div>
    <div class="credits">
    </div>
  </footer><!-- End Footer -->
  ...
  <script src="<?php echo base_url(); ?>assets/admin/assets/vendor/quill/quill.min.js"></script>
